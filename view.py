...
# Ventana 1
window1 = create_button_frame(app, "Punto 1")
window1.place(x=0, y=0, width=600, height=500)
button1 = tk.Button(main_frame, text="Punto 1", command=lambda: show_frame(window1), font=("Arial", 12), bg='#4d4d4d',
                   fg='#ffffff', padx=20, pady=5)
...
# Ventana 2
window2 = create_button_frame(app, "Punto 2")
window2.place(x=0, y=0, width=600, height=500)
button2 = tk.Button(main_frame, text="Punto 2", command=lambda: show_frame(window2), font=("Arial", 12), bg='#4d4d4d',
                   fg='#ffffff', padx=20, pady=5)
...
# Ventana 3
window3 = create_button_frame(app, "Punto 3")
window3.place(x=0, y=0, width=600, height=500)
button3 = tk.Button(main_frame, text="Punto 3", command=lambda: show_frame(window3), font=("Arial", 12), bg='#4d4d4d',
                   fg='#ffffff', padx=20, pady=5)
...
# Ventana 4
window4 = create_button_frame(app, "Punto 4")
window4.place(x=0, y=0, width=600, height=500)
button4 = tk.Button(main_frame, text="Punto 4", command=lambda: show_frame(window4), font=("Arial", 12), bg='#4d4d4d',
                   fg='#ffffff', padx=20, pady=5)
...
label_lindos = tk.Label(main_frame, text="By: Julian Isaza G & Santiago Franco M", font=("Arial", 14), bg='#7587c6', fg='#ffffff')
label_lindos.pack(pady=10)
